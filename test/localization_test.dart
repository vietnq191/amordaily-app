      ...
      test('Language [$lang] should have all expected keys', () {
        ...
        for (final key in expectedKeys) {
          ...
          expect(
            translated,
            isNotEmpty,
            reason: 'Key [$key] is empty in language [$lang]',
          );
          ...
          if (lang != 'en' && lang != 'vi') {
            ...
            if (key != 'app_name') {
              expect(
                translated,
                isNot(equals(key)),
                reason: 'Key [$key] might not be translated in [$lang]',
              );
            }
          }
        }
